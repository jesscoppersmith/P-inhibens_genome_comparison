#!/bin/bash
#SBATCH --job-name="panacota-align-subset"
...
PERS_GENOME=/data/marine_diseases_lab/jessica/src/phaeobacter_comparison_2023/panacota/corepers-subset_out/PersGenome_PanGenome-PHIN37.All.prt-clust-0.8-mode1-th16.lst-LSTINFO_Probionts.lst_1.lst
