#!/bin/bash
#SBATCH --job-name="panacota-corepers-subset"
...
LSTINFO=/data/marine_diseases_lab/jessica/src/phaeobacter_comparison_2023/panacota/pangenome_out/LSTINFO_Probionts.lst
