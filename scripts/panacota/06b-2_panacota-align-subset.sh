#!/bin/bash
#SBATCH --job-name="panacota-align-subset-2"
...
OUT_DIR=/data/marine_diseases_lab/jessica/src/phaeobacter_comparison_2023/panacota/align-subset_out
DB_DIR=/data/marine_diseases_lab/jessica/src/phaeobacter_comparison_2023/panacota/annotation_out/
PERS_GENOME=/data/marine_diseases_lab/jessica/src/phaeobacter_comparison_2023/panacota/corepers-subset_out/PersGenome_PanGenome-PHIN37.All.prt-clust-0.8-mode1-th16.lst-LSTINFO_Probionts_w-outgroup.lst_1.lst
LIST_FILE=/data/marine_diseases_lab/jessica/src/phaeobacter_comparison_2023/panacota/annotation_out/LSTINFO-LSTINFO-NA-filtered-SUBSET-0.0001_0.06.lst
THREADS=16
