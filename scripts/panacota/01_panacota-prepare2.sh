...
#--norefseq indicates that we are Starting at step 2 as the genomes were already obtained from NCBI
#Purpose Quality control to filter assemblies in terms of sequence quality and
#Filtering step dedicated to remove redundant and miss-classified genomes, based on Mash genetic distance.
