...
outDIR=/data/marine_diseases_lab/jessica/src/phaeobacter_comparison_2023/cactus/chrom-alignments
chromFILE=/data/marine_diseases_lab/jessica/src/phaeobacter_comparison_2023/cactus/P-inhibens_chroms/chromfile.txt

module purge
module load Cactus
module list

cactus-align $jobStorePath $chromFILE $outDIR \
--batch --pangenome --reference P54 --outVG --binariesMode=local
#chromFILE is output from the split step. New outDIR for this step
